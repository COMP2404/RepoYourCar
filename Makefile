...
test:	operatorTest.cpp Model/UndergradStudent.cpp Model/UndergradStudent.h Model/UndergradApp.cpp Model/UndergradApp.h Model/GradStudent.cpp Model/GradStudent.h Model/GradApp.cpp Model/GradApp.h
		g++ -c operatorTest.cpp
		g++ -o test operatorTest.o Course.o Job.o Student.o UndergradStudent.o GradStudent.o UndergradApp.o GradApp.o Application.o
