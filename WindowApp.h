...
class WindowApp{
	public:
		...
		GtkWidget *studentWindow, *studentFrame, *submitFinish, *student_edit, *btnStudent,*admin_window,*admin_combo, *admin_frame, *admin_cancel , *admin_viewSummary, *admin_login;
