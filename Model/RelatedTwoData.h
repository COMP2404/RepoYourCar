#ifndef RELATED_TWO_DATA
#define RELATED_TWO_DATA
#include <iostream>
#include <string.h>
#include <fstream>
#include <stdio.h>
...
class RelatedTwoData{
	...
	private:
		...
		/*void create(GradForm*,UnderGradForm*);
		static void close(GtkWidget*,GradForm*);
		static void finishUGrad(GtkWidget*,UnderGradForm*);
		static void finishGrad(GtkWidget*,GradForm*);
		static void addAnotherUGrad(GtkWidget*,UnderGradForm*);
		static void addAnotherGrad(GtkWidget*,GradForm*);
		static bool errorCheckUGrad(UnderGradForm*);
		static bool errorCheckGrad(GradForm*);
		static void cleanupGrad(GradForm*);
		static void cleanupUGrad(UnderGradForm*);*/
