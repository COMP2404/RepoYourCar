...
void Control::relatedCourses2(GtkWidget *widget, WindowApp *theApp){
	...
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_repeat2, 500, 430);

	gtk_widget_set_size_request(theApp->ei_continue2, 80, 35);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_continue2, 380, 430);
...
void Control::workExperience(GtkWidget *widget, WindowApp *theApp){
	...
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_finish, 380, 430);

	gtk_widget_set_size_request(theApp->ei_repeat3, 80, 35);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_repeat3, 500, 430);
	

	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_relevantWork, 400, 280);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_responsabilities, 400, 310);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_duration, 400, 340);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_startDate, 400, 370);
	gtk_fixed_put(GTK_FIXED(theApp->appFrame), theApp->ei_endDate, 400, 400);
	gtk_widget_show_all(theApp->appFrame);
